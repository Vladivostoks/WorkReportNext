...
<el-card>
  ...
  <Timeline v-if="prop.data.uuid" :uuid="prop.data.uuid" :start_time="prop.data.date" :end_time="end_time" 
            :editable="!(viewback || mode==TableContentType.HistoryItem || mode==TableContentType.Repository)"
            :item_name="prop.data.name"
            :item_brief="prop.data.describe"
